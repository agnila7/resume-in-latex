...
%-------------------------------------------
    ...
    \resumeSubheading
    {Graduate Teaching Assistant}{Jan.2020 -- Jan. 2023}
    ...
    \resumeSubheading
      {Next Generation Wireless Communication Research Assistant}{Jan.2019 -- Dec. 2019}
      {University of Windsor}{Windsor, ON}
      \resumeItemListStart
...
\section{Courses}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{AWS re/Start Program} $|$ \emph{MATLAB, PSPICE, OptiSystems, Code::Blocks, VS Code, MikTex}}{June 2020 -- Present}
          \resumeItemListStart
          ...
          \resumeItemListEnd
          \resumeProjectHeading
          {\textbf{Graduate} $|$ \emph{MATLAB, PSPICE, OptiSystems, Code::Blocks, VS Code, MikTex}}{June 2020 -- Present}
          \resumeItemListStart
            \resumeItem{Digital Communication; Stochastic Process; Wireless Communication; Estimation, Tracking, Navigation }
            \resumeItem{Information Transmission System, Digital Signal Processing, Engineering Technical Communication}
          \resumeItemListEnd
